...
// MVC Request Flow - Web Dev Simplified
...
function groupIntoSections(words: WordTimestamp[], fps: number): SectionTimestamp[] {
  ...
  // MVC Flow section markers - matching exact transcript
  const sectionMarkers = [
    { keyword: "sends a request", section: "USER_REQUEST" },
    { keyword: "to the controller", section: "CONTROLLER_RECEIVES" },
    { keyword: "ask the model", section: "MODEL_REQUEST" },
    { keyword: "query the database", section: "DATABASE_QUERY" },
    { keyword: "return that list back", section: "MODEL_RESPONSE" },
    { keyword: "ask the view", section: "VIEW_REQUEST" },
    { keyword: "render the list into HTML", section: "HTML_RENDER" },
    { keyword: "return it back to the user", section: "USER_RESPONSE" },
  ];
