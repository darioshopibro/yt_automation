  ...
  <svg width={40} height={20} viewBox="0 0 40 20">
    <defs>
      <marker id="arrowhead" markerWidth="8" markerHeight="8" refX="6" refY="4" orient="auto">
        <path d="M0,0 L8,4 L0,8 Z" fill={layoutColors.line} />
      </marker>
    </defs>
    <line x1="0" y1="10" x2="32" y2="10" stroke={layoutColors.line} strokeWidth="2" markerEnd="url(#arrowhead)" />
  </svg>
);
  ...
  <svg width={40} height={20} viewBox="0 0 40 20">
    <defs>
      <marker id="arrowL" markerWidth="6" markerHeight="6" refX="0" refY="3" orient="auto">
        <path d="M6,0 L0,3 L6,6 Z" fill={layoutColors.line} />
      </marker>
      <marker id="arrowR" markerWidth="6" markerHeight="6" refX="6" refY="3" orient="auto">
        <path d="M0,0 L6,3 L0,6 Z" fill={layoutColors.line} />
      </marker>
    </defs>
    <line x1="8" y1="10" x2="32" y2="10" stroke={layoutColors.line} strokeWidth="2" markerStart="url(#arrowL)" markerEnd="url(#arrowR)" />
  </svg>
);

const FilterArrow: React.FC = () => (
  <svg width={40} height={20} viewBox="0 0 40 20">
    <polygon points="5,2 5,18 25,10" fill="none" stroke={layoutColors.line} strokeWidth="2" />
    <line x1="25" y1="10" x2="38" y2="10" stroke={layoutColors.line} strokeWidth="2" />
  </svg>
);
...
const VsSymbol: React.FC = () => (
  <div
    style={{
      fontSize: 16,
      fontWeight: 800,
      color: layoutColors.orange,
      textShadow: `0 0 10px ${layoutColors.orange}60`,
      padding: "0 8px",
    }}
  >
    vs
...
const EqualsSymbol: React.FC = () => (
  <div
    style={{
      fontSize: 20,
      fontWeight: 700,
      color: layoutColors.green,
      textShadow: `0 0 10px ${layoutColors.green}60`,
      padding: "0 4px",
    }}
  >
    =
