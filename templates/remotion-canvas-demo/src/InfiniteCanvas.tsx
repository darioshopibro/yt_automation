...
export const InfiniteCanvas: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* CAMERA TRANSITION WHOOSHES - start 2 frames before transition */}
      <Sequence from={218} durationInFrames={30}>
        <Audio src={staticFile("sounds/whooshes/medium-whoosh.mp3")} volume={0.25} />
      </Sequence>
      <Sequence from={513} durationInFrames={30}>
        <Audio src={staticFile("sounds/whooshes/medium-whoosh.mp3")} volume={0.25} />
      </Sequence>
      <Sequence from={838} durationInFrames={30}>
        <Audio src={staticFile("sounds/whooshes/medium-whoosh.mp3")} volume={0.25} />
      </Sequence>
      <Sequence from={1138} durationInFrames={30}>
        <Audio src={staticFile("sounds/whooshes/medium-whoosh.mp3")} volume={0.25} />
      </Sequence>
      <Sequence from={1386} durationInFrames={30}>
        <Audio src={staticFile("sounds/whooshes/medium-whoosh.mp3")} volume={0.25} />
      </Sequence>

      {/* SECTION BOX REVEALS - tiši da camera dominira */}
      ...
      <Sequence from={530} durationInFrames={20}>
        <Audio src={staticFile("sounds/whooshes/soft-whoosh.mp3")} volume={0.12} />
      </Sequence>
      <Sequence from={855} durationInFrames={20}>
        <Audio src={staticFile("sounds/whooshes/soft-whoosh.mp3")} volume={0.12} />
      </Sequence>
      <Sequence from={1160} durationInFrames={20}>
        <Audio src={staticFile("sounds/whooshes/soft-whoosh.mp3")} volume={0.12} />
      </Sequence>
      <Sequence from={1405} durationInFrames={20}>
        <Audio src={staticFile("sounds/whooshes/soft-whoosh.mp3")} volume={0.12} />
      </Sequence>
