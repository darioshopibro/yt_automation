...
function groupIntoSections(words: WordTimestamp[], fps: number): SectionTimestamp[] {
  ...
  const sectionMarkers = [
    { keyword: "benefits", section: "BENEFITS" },
    { keyword: "automate", section: "AUTOMATION" },
    { keyword: "velocity", section: "VELOCITY" },
    { keyword: "detects", section: "DETECTION" },
    { keyword: "disasters", section: "DISASTERS" },
    { keyword: "quality", section: "CODE_QUALITY" },
  ];
