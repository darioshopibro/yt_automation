...
// WebSockets Explained - Fireship style
const SCRIPT = `
WebSockets provide full duplex communication between client and server. Unlike HTTP which is request response, WebSockets keep a persistent connection open. The client sends an upgrade request, the server accepts, and now both sides can send messages anytime. This is perfect for real-time apps like chat, gaming, and live dashboards.
`.trim();
...
function groupIntoSections(words: WordTimestamp[], fps: number): SectionTimestamp[] {
  ...
  // WebSockets section markers
  const sectionMarkers = [
    // Sticky 1: Protocol
    { keyword: "full duplex", section: "FULL_DUPLEX" },
    { keyword: "client and server", section: "CLIENT_SERVER" },
    { keyword: "Unlike HTTP", section: "VS_HTTP" },
    // Sticky 2: Handshake
    { keyword: "persistent connection", section: "PERSISTENT" },
    { keyword: "upgrade request", section: "UPGRADE" },
    { keyword: "both sides", section: "BIDIRECTIONAL" },
    // Sticky 3: Use Cases
    { keyword: "real-time apps", section: "REALTIME" },
    { keyword: "gaming", section: "GAMING" },
    { keyword: "dashboards", section: "DASHBOARDS" },
  ];
